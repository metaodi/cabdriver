...
Github.prototype.getContributions = function(callback, auth, options) {
    ...
    me.getGitHubUsername(gh)
        .then(function(username) {
            helper.printVerbose('Gather GitHub events: [', options.verbose);
            return me.getUserEvents(gh, username, options);
        })
...
Github.prototype.getApi = function(token) {
...
Github.prototype.eventDescription = function(userEvent, options) {
...
Github.prototype.getUserEvents = function(gh, username, options) {
    var me = this;
    ...
    return me.getAllItems(gh, activityPromise, options.verbose)
        .then(function(result) {
...
Github.prototype.getAllItems = function(gh, promise, verbose) {
    var allItems = [];
